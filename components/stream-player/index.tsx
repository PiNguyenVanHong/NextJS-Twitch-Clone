...
import Chat, { ChatSkeleton } from "@/components/stream-player/chat/index";
...
const StreamPlayer = ({
    ...
    return ( 
        ...
        {collapsed && (
            ...
            <LiveKitRoom 
                token={token} 
                serverUrl={process.env.NEXT_PUBLIC_LIVEKIT_WS_URL} className={cn("grid grid-cols-1 lg:gap-y-0 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 h-full",
